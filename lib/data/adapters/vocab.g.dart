...
class VocabInfoAdapter extends TypeAdapter<VocabInfo> {
  @override
  final int typeId = 4;

  @override
  VocabInfo read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
  ...
  @override
  void write(BinaryWriter writer, VocabInfo obj) {
    writer
      ..writeByte(5)
      ..writeByte(0)
      ..write(obj.vocab)
