...
class _BookListen extends State<BookListen> {
        ...
        setState(() {
          ...
          if (_position.inSeconds % 30 == 0) {
            _bookBloc.add(UpdateCkptEvent(
                ...
                ckpt: _position.inSeconds.toInt(),
                isEbook: false));
          }
        });
      }
  ...
  void setAudioBook(state) async {
    ...
    await audioPlayer.play(UrlSource(widget.bookInfo.mp3Url!),
        position: _position);
              ...
              body: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                      image: NetworkImage(widget.bookInfo.coverUrl!),
                      fit: BoxFit.cover),
                ),
                                          ...
                                          ? Row(
                                              mainAxisAlignment:
                                                  MainAxisAlignment
                                                      .spaceBetween,
                                              children: [
                                                (_position.inSeconds % 60) > 9
                                                    ? Text(
                                                        "${_position.inMinutes.toString()}:${(_position.inSeconds % 60).toString()}")
                                                    : Text(
                                                        "${_position.inMinutes.toString()}:0${(_position.inSeconds % 60).toString()}"),
                                                ((_duration - _position)
                                                                .inSeconds %
                                                            60) >
                                                        9
                                                    ? Text(
                                                        "${(_duration - _position).inMinutes.toString()}:${((_duration - _position).inSeconds % 60).toString()}")
                                                    : Text(
                                                        "${(_duration - _position).inMinutes.toString()}:0${((_duration - _position).inSeconds % 60).toString()}")
                                              ],
                                            )
                                          : Row(
                                              mainAxisAlignment:
