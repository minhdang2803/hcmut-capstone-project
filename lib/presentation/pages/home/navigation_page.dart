...
import 'package:bke/presentation/widgets/input_field.dart';
...
class _NavigationPageState extends State<NavigationPage>{
  ...
  Widget build(BuildContext context) {
    final List<String> menuList = <String>['video', 'book', 'flashcard', 'test', 'puzzle', 'chat'];
          ...
          children: [
            Visibility(
              ...
              child: Container(
                ...
                child: ContinueCard(recentAction: RecentAction.readBook.index)
              )
            ),
            ...
            Padding(
              ...
              child: 
              TextButton(
                onPressed: () { showSearch(context: context, delegate: MonasterySearchDelegate()) ;  },
                child: 
                  ClipRRect(
                    borderRadius: BorderRadius.circular(20),
                    child: 
